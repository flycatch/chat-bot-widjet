...
const ChatBotHeader = ({ onClose, isBotTyping }) => (
    ...
    <div className="widjet_chatbot_flycatch_chat-text">
      ...
      <div>
        ...
        <div className="widjet_chatbot_flycatch_online-txt">
          {" "}
          {isBotTyping ? ChatBotConstants.TYPING : ChatBotConstants.ONLINE}
        </div>
      </div>
    </div>
    <div className="widjet_chatbot_flycatch_close-button" onClick={onClose}>
      <svg
        width="14"
        height="14"
        viewBox="0 0 14 14"
