...
const BotMessage = ({ answer, message, options }) => {
    ...
    <>
      <div className="widjet_chatbot_flycatch_avatar-chat">
        ...
        <div className="widjet_chatbot_flycatch_text">
          {answer ? (
            <>
              <div className="widjet_chatbot_flycatch_faq">{message}</div>
              {FAQOpen&& (
                <div className="widjet_chatbot_flycatch_faq_answer ">
                  {answer}
                </div>
              )}
              <div
